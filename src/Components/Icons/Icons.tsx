...
export const CircleBlue: React.FC<Props> = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UnMuted: React.FC<Props> = ({ width = '32', height = '32', className }) => (
    <svg
        className={className}
        width={width}
        // dataE2e=""
...
export const Muted: React.FC<Props> = ({ width = '32', height = '32', className }) => (
    <svg
        className={className}
        width={width}
        // dataE2e=""
...
export const GoToTop: React.FC<Props> = ({ width = '18', height = '18', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const FacebookIcon: React.FC<Props> = ({ width = '32', height = '32', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const GoogleIcon: React.FC<Props> = ({ width = '32', height = '32', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LKeyboard: React.FC<Props> = ({ width = '24', height = '24', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const MKeyboard: React.FC<Props> = ({ width = '24', height = '24', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const ArrowUp: React.FC<Props> = ({ width = '24', height = '24', className }) => (
    <svg
        width={width}
        className={className}
        height={height}
...
export const ArrowDown: React.FC<Props> = ({ width = '24', height = '24', className }) => (
    <svg
        width={width}
        className={className}
        height={height}
...
export const CommentVideo: React.FC<Props> = ({ width = '24', height = '24', className }) => (
...
export const FavoriteVideo: React.FC<Props> = ({ width = '30', height = '30' }, props) => (
...
export const UploadVideo: React.FC<Props> = ({ width = '48', height = '48', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const Cut: React.FC<Props> = ({ width = '16', height = '16', className }) => (
    <svg
        fill="currentColor"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
...
export const Minus: React.FC<Props> = ({ width = '16', height = '16', className }) => (
    <svg
        fill="currentColor"
        color="#b0b0b4"
        viewBox="0 0 48 48"
...
export const Plus: React.FC<Props> = ({ width = '16', height = '16', className }) => (
    <svg
        fill="currentColor"
        color="#b0b0b4"
        viewBox="0 0 48 48"
...
export const ReSize: React.FC<Props> = ({ width = '16', height = '16', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const MobileLive: React.FC<Props> = ({ width = '26', height = '26', className, tabIndex }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
...
export const MobileSearch: React.FC<Props> = ({ width = '26', height = '26', className, tabIndex }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
...
export const MobileBarIcons: React.FC<Props> = ({ width = '29', height = '125', className, tabIndex }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
...
export const Tag: React.FC<Props> = ({ width = '26', height = '26', className }) => (
    <svg
        fill="currentColor"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
...
export const HashTag: React.FC<Props> = ({ width = '26', height = '26', className }) => (
    <svg
        fill="currentColor"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="m17.74 15.5.68-6.6a1 1 0 0 1 1-.9h.97a1 1 0 0 1 1 1.1l-.63 6.4h7.98l.68-6.6a1 1 0 0 1 1-.9h.97a1 1 0 0 1 1 1.1l-.63 6.4H37a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-5.54l-.8 8H36a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-5.64l-.78 7.6a1 1 0 0 1-1 .9h-.97a1 1 0 0 1-1-1.1l.73-7.4h-7.98l-.78 7.6a1 1 0 0 1-1 .9h-.97a1 1 0 0 1-1-1.1l.73-7.4H11a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h5.64l.8-8H12a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h5.74Zm2.72 3-.8 8h7.98l.8-8h-7.98Z"
        ></path>
    </svg>
)

export const CircleInfo: React.FC<Props> = ({ width = '18', height = '19', className }) => (
    <svg
        viewBox="0 0 18 19"
        fill="none"
        width={width}
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M9 2.75C5.27208 2.75 2.25 5.77208 2.25 9.5C2.25 13.2279 5.27208 16.25 9 16.25C12.7279 16.25 15.75 13.2279 15.75 9.5C15.75 5.77208 12.7279 2.75 9 2.75ZM0.75 9.5C0.75 4.94365 4.44365 1.25 9 1.25C13.5563 1.25 17.25 4.94365 17.25 9.5C17.25 14.0563 13.5563 17.75 9 17.75C4.44365 17.75 0.75 14.0563 0.75 9.5ZM10.125 6.5C10.125 7.12132 9.62132 7.625 9 7.625C8.37868 7.625 7.875 7.12132 7.875 6.5C7.875 5.87868 8.37868 5.375 9 5.375C9.62132 5.375 10.125 5.87868 10.125 6.5ZM8.625 8.75C8.41789 8.75 8.25 8.91789 8.25 9.125V13.25C8.25 13.4571 8.41789 13.625 8.625 13.625H9.375C9.58211 13.625 9.75 13.4571 9.75 13.25V9.125C9.75 8.91789 9.58211 8.75 9.375 8.75H8.625Z"
            fill="currentColor"
            fillOpacity="0.34"
        ></path>
    </svg>
...
export const ArrowDownSelect: React.FC<Props> = ({ width = '18', height = '19', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const CheckboxTick: React.FC<Props> = ({ width = '18', height = '19', className }) => {
    return (
        <svg
            width={width}
            height={height}
